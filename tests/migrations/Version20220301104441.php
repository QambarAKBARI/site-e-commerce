 ...
 */
final class Version20220301104441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, date_commande DATETIME NOT NULL, adresse_livraison VARCHAR(255) NOT NULL, cp_livraison VARCHAR(50) NOT NULL, ville_livraison VARCHAR(50) NOT NULL, status VARCHAR(100) NOT NULL, CONSTRAINT FK_6EEAA67DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
