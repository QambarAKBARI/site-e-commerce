 ...
 */
final class Version20220301190615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__commande AS SELECT id, user_id, date_commande, adresse_livraison, cp_livraison, ville_livraison, status FROM commande');
        ...
        $this->addSql('INSERT INTO commande (id, user_id, date_commande, adresse_livraison, cp_livraison, ville_livraison, status) SELECT id, user_id, date_commande, adresse_livraison, cp_livraison, ville_livraison, status FROM __temp__commande');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__commande AS SELECT id, user_id, date_commande, adresse_livraison, cp_livraison, ville_livraison, status FROM commande');
        $this->addSql('DROP TABLE commande');
        $this->addSql('CREATE TABLE commande (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, date_commande DATETIME NOT NULL, adresse_livraison VARCHAR(255) NOT NULL, cp_livraison VARCHAR(50) NOT NULL, ville_livraison VARCHAR(50) NOT NULL, status VARCHAR(100) NOT NULL)');
        $this->addSql('INSERT INTO commande (id, user_id, date_commande, adresse_livraison, cp_livraison, ville_livraison, status) SELECT id, user_id, date_commande, adresse_livraison, cp_livraison, ville_livraison, status FROM __temp__commande');
        $this->addSql('DROP TABLE __temp__commande');
        $this->addSql('CREATE INDEX IDX_6EEAA67DA76ED395 ON commande (user_id)');
        $this->addSql('DROP INDEX IDX_29A5EC274827B9B2');
