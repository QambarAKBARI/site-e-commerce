 ...
 */
final class Version20220221204128 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, nom, prenom, adresse, cp, ville FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , password VARCHAR(255)  NULL, nom VARCHAR(100)  NULL, prenom VARCHAR(100)  NULL, adresse VARCHAR(255)  NULL, cp VARCHAR(50)  NULL, ville VARCHAR(50)  NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, nom, prenom, adresse, cp, ville) SELECT id, email, roles, password, nom, prenom, adresse, cp, ville FROM __temp__user');
