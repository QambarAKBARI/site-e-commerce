 ...
 */
final class Version20220222140452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__commande AS SELECT id, user_id, date_commande, adresse_livraison, cp_livraison, ville_livraison FROM commande');
        $this->addSql('DROP TABLE commande');
        $this->addSql('CREATE TABLE commande (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, date_commande DATETIME NOT NULL, adresse_livraison VARCHAR(255) NOT NULL, cp_livraison VARCHAR(50) NOT NULL, ville_livraison VARCHAR(50) NOT NULL, CONSTRAINT FK_6EEAA67DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO commande (id, user_id, date_commande, adresse_livraison, cp_livraison, ville_livraison) SELECT id, user_id, date_commande, adresse_livraison, cp_livraison, ville_livraison FROM __temp__commande');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__produit AS SELECT id, marque_id, sous_categorie_id, prix, image, nom_produit, quantite FROM produit');
        $this->addSql('DROP TABLE produit');
        $this->addSql('CREATE TABLE produit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, marque_id INTEGER DEFAULT NULL, sous_categorie_id INTEGER DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, image VARCHAR(255) DEFAULT NULL, nom_produit VARCHAR(255) NOT NULL, quantite INTEGER NOT NULL, CONSTRAINT FK_29A5EC274827B9B2 FOREIGN KEY (marque_id) REFERENCES marque (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_29A5EC27365BF48 FOREIGN KEY (sous_categorie_id) REFERENCES sous_categorie (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO produit (id, marque_id, sous_categorie_id, prix, image, nom_produit, quantite) SELECT id, marque_id, sous_categorie_id, prix, image, nom_produit, quantite FROM __temp__produit');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, nom, prenom, adresse, cp, ville, is_verified FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , password VARCHAR(255) NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, adresse VARCHAR(255) NOT NULL, cp VARCHAR(50) NOT NULL, ville VARCHAR(50) NOT NULL, is_verified BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, nom, prenom, adresse, cp, ville, is_verified) SELECT id, email, roles, password, nom, prenom, adresse, cp, ville, is_verified FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__commande AS SELECT id, user_id, date_commande, adresse_livraison, cp_livraison, ville_livraison FROM commande');
        $this->addSql('DROP TABLE commande');
        $this->addSql('CREATE TABLE commande (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, date_commande DATETIME NOT NULL, adresse_livraison VARCHAR(255) NOT NULL, cp_livraison VARCHAR(50) NOT NULL, ville_livraison VARCHAR(50) NOT NULL)');
        $this->addSql('INSERT INTO commande (id, user_id, date_commande, adresse_livraison, cp_livraison, ville_livraison) SELECT id, user_id, date_commande, adresse_livraison, cp_livraison, ville_livraison FROM __temp__commande');
        $this->addSql('DROP TABLE __temp__commande');
        $this->addSql('CREATE INDEX IDX_6EEAA67DA76ED395 ON commande (user_id)');
        $this->addSql('DROP INDEX IDX_29A5EC274827B9B2');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__produit AS SELECT id, marque_id, sous_categorie_id, prix, image, nom_produit, quantite FROM produit');
        $this->addSql('DROP TABLE produit');
        $this->addSql('CREATE TABLE produit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, marque_id INTEGER DEFAULT NULL, sous_categorie_id INTEGER DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, image VARCHAR(255) DEFAULT NULL, nom_produit VARCHAR(255) NOT NULL, quantite INTEGER NOT NULL)');
        $this->addSql('INSERT INTO produit (id, marque_id, sous_categorie_id, prix, image, nom_produit, quantite) SELECT id, marque_id, sous_categorie_id, prix, image, nom_produit, quantite FROM __temp__produit');
        $this->addSql('DROP TABLE __temp__produit');
        $this->addSql('CREATE INDEX IDX_29A5EC274827B9B2 ON produit (marque_id)');
        $this->addSql('CREATE INDEX IDX_29A5EC27365BF48 ON produit (sous_categorie_id)');
        ...
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , password VARCHAR(255) NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, adresse VARCHAR(255) NOT NULL, cp VARCHAR(50) NOT NULL, ville VARCHAR(50) NOT NULL, is_verified BOOLEAN DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, nom, prenom, adresse, cp, ville, is_verified) SELECT id, email, roles, password, nom, prenom, adresse, cp, ville, is_verified FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
    }
