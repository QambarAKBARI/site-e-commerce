 ...
 */
final class Version20220221122709 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__avis AS SELECT id, texte, note, date_depot FROM avis');
        ...
        $this->addSql('INSERT INTO avis (id, texte, note, date_depot) SELECT id, texte, note, date_depot FROM __temp__avis');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__commande AS SELECT id, date_commande, adresse_livraison, cp_livraison, ville_livraison FROM commande');
        ...
        $this->addSql('INSERT INTO commande (id, date_commande, adresse_livraison, cp_livraison, ville_livraison) SELECT id, date_commande, adresse_livraison, cp_livraison, ville_livraison FROM __temp__commande');
        $this->addSql('DROP TABLE __temp__commande');
        $this->addSql('CREATE INDEX IDX_6EEAA67DA76ED395 ON commande (user_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__produit AS SELECT id, prix, image, nom_produit, quantite FROM produit');
        ...
        $this->addSql('INSERT INTO produit (id, prix, image, nom_produit, quantite) SELECT id, prix, image, nom_produit, quantite FROM __temp__produit');
        ...
        , password VARCHAR(255) NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, adresse VARCHAR(255) NOT NULL, cp VARCHAR(50) NOT NULL, ville VARCHAR(50) NOT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , password VARCHAR(255) NOT NULL, nom VARCHAR(100) DEFAULT NULL, prenom VARCHAR(100) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, cp VARCHAR(50) DEFAULT NULL, ville VARCHAR(50) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, nom, prenom, adresse, cp, ville) SELECT id, email, roles, password, nom, prenom, adresse, cp, ville FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
    }
