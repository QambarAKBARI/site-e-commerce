 ...
 */
final class Version20220309124607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__produit_commande AS SELECT id, commande_id, produit_id, quantite, total FROM produit_commande');
        ...
        $this->addSql('INSERT INTO produit_commande (id, commande_id, produit_id, quantite, total) SELECT id, commande_id, produit_id, quantite, total FROM __temp__produit_commande');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__produit_commande AS SELECT id, commande_id, produit_id, quantite, total FROM produit_commande');
        $this->addSql('DROP TABLE produit_commande');
        $this->addSql('CREATE TABLE produit_commande (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, commande_id INTEGER NOT NULL, produit_id INTEGER NOT NULL, quantite INTEGER NOT NULL, total INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO produit_commande (id, commande_id, produit_id, quantite, total) SELECT id, commande_id, produit_id, quantite, total FROM __temp__produit_commande');
        $this->addSql('DROP TABLE __temp__produit_commande');
        $this->addSql('CREATE INDEX IDX_47F5946E82EA2E54 ON produit_commande (commande_id)');
        $this->addSql('CREATE INDEX IDX_47F5946EF347EFB ON produit_commande (produit_id)');
