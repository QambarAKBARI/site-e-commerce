 ...
 */
final class Version20220225132101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__produit AS SELECT id, marque_id, sous_categorie_id, prix, image, nom_produit, quantite, description FROM produit');
        ...
        $this->addSql('INSERT INTO produit (id, marque_id, sous_categorie_id, prix, image, nom_produit, quantite, description) SELECT id, marque_id, sous_categorie_id, prix, image, nom_produit, quantite, description FROM __temp__produit');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__produit AS SELECT id, marque_id, sous_categorie_id, prix, image, nom_produit, quantite, description FROM produit');
        $this->addSql('DROP TABLE produit');
        $this->addSql('CREATE TABLE produit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, marque_id INTEGER DEFAULT NULL, sous_categorie_id INTEGER DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, image VARCHAR(255) DEFAULT NULL, nom_produit VARCHAR(255) NOT NULL, quantite INTEGER NOT NULL, description CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO produit (id, marque_id, sous_categorie_id, prix, image, nom_produit, quantite, description) SELECT id, marque_id, sous_categorie_id, prix, image, nom_produit, quantite, description FROM __temp__produit');
        $this->addSql('DROP TABLE __temp__produit');
        $this->addSql('CREATE INDEX IDX_29A5EC274827B9B2 ON produit (marque_id)');
        $this->addSql('CREATE INDEX IDX_29A5EC27365BF48 ON produit (sous_categorie_id)');
